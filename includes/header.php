...
<header class="header">
    <div class="container header-container">
        <a href="index.php" class="logo">Monogram</a>
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            ...
            <nav class="main-nav">
                ...
                <a href="create-story.php" class="nav-link">
                ...
                <a href="profile.php?username=<?php echo $_SESSION['username']; ?>" class="nav-link profile-link">
                    <?php
                    $current_user = getUserById($_SESSION['user_id']);
                    $profile_pic = $current_user['profile_pic'] ? $current_user['profile_pic'] : 'assets/images/default-avatar.png';
                    ?>
                    <img src="<?php echo $profile_pic; ?>" alt="<?php echo $_SESSION['username']; ?>" class="profile-pic-small">
                </a>
